from src.utils.data_processing.extract_features_3 import extract_animal_features
import pandas as pd
import os



def master_features(inputs_paste_pngs="output/melhoresFrames/pngs", inputs_paste_csvs="output/melhoresFrames/csvs", output_dataset_dir="data/processed/datasets"):
    ...
    dataset_csv_path = os.path.join(output_dataset_dir, "dataset.csv")
