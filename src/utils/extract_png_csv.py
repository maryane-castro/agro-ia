from src.utils.data_processing.extract_svo_png import extract_images
from src.utils.data_processing.extract_svo_csv import extract_depth
import os


def master_extract(svo_directory="svos-testes", output_base_dir="output/extracoes"):
